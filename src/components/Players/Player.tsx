...
const PlayerComponent: React.FC<PlayerProps> = ({ player, onClick }) => {
  ...
  return (
    <div
      ...
      className="player w-64 h-100 md:w-96 md:h-120 lg:w-120 lg:h-160 rounded-lg overflow-hidden shadow-md m-4 cursor-pointer bg-blue-100 hover:transform hover:scale-105 hover:transition-transform hover:duration-300 hover:bg-blue-200"
      onClick={onClick}
    >
      <img
        src={pictureUrl}
