  ...
  return (
    <div className="bg-yellow-100 p-4 rounded shadow-md mb-4">
      ...
      <p className="text-gray-700 text-base">
          <span className="font-bold text-teal-600">Start Time:</span> {formatDate(match.startTime) }
        </p>
        <p className="text-gray-700 text-base">
          <span className="font-bold text-teal-600">End Time:</span> {formatDate(match.endTime) }
        </p>
      <h5 className="text-indigo-600 text-lg font-semibold mt-4 mb-2">Players:</h5>
